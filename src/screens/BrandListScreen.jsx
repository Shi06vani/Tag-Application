...
const BrandListScreen = () => {
  ...
  return (
    <View className="flex-1 bg-purple-100 p-[15px]">
      <Text className="text-3xl font-bold text-center text-purple-800 mb-3">Popular Brands</Text>
      <TextInput
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity className="bg-white px-3 py-2 mb-2 rounded-2xl shadow-lg flex-row items-center">
            ...
            <View>
              <Text className="text-xl font-semibold text-purple-700">{item.name}</Text>
